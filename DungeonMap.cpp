...
DungeonMap::DungeonMap(irr::IrrlichtDevice &device, std::string &mapPath)
{
	using namespace irr;
	using namespace io;
...
void DungeonMap::loadDungeonFile(std::string &mapPath)
{
	...
	startPosition = irr::core::vector2di(startPositionX, startPositionY);
...
irr::core::vector2di DungeonMap::getStartPosition()
{
