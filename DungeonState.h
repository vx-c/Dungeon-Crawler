    ...
    public GameState
{
	...
	irr::core::vector2di playerPosition;
...
public:
	...
	DungeonState(irr::IrrlichtDevice &device, SoundManager &soundManager, std::string dungeonMapPath);
	~DungeonState();
	...
	void readyStateChange();
        ...
        // generate and get some enemies
        std::vector<EnemyUnit> getEnemies();
};
