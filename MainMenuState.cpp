...
void MainMenuState::initializeScene()
{
	...
	device->getGUIEnvironment()->addButton(rect<s32>(300, 150, 500, 250), 0, GUI_ID_START_BUTTON,
		L"Start Game", L"Start the game");
	device->getGUIEnvironment()->addButton(rect<s32>(300, 350, 500, 450), 0, GUI_ID_QUIT_BUTTON,
