...
Skill Skills::cleave = Skill(Skill::ID::Cleave, Skill::TargetingID::All, L"Cleave", L"cleaves");
Skill Skills::fireball = Skill(Skill::ID::Fireball, Skill::TargetingID::Single, L"Fireball", L"casts fireball on");
Skill Skills::firewave = Skill(Skill::ID::Firewave, Skill::TargetingID::All, L"Firewave", L"casts firewave on");
